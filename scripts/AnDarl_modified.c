#include <stdio.h>
#include <stdlib.h> // Bernardo added
#include <math.h>
...
/*
 ...
 where z_1=1-x_n, z_2=1-x_(n-1)...z_n=1-x_1, then find
  ...
  modified by Bernardo Carvalho  1jan2025 to simplify the run: no denmo, no infinite loop, just accepts n, Z, and returns P value
*/
...
int main (int numargs, char *arg[]) {
   if (numargs != 3) {
      printf ("Wrong number of arguments. Expected 2: sample size and the Anderson-Darling stats \n");
   }	
   int n = atoi (arg[1] );
   double z = atof (arg[2]);
   // printf("%2d\n",n);
